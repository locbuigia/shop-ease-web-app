...
const AboutUs = () => {
  return (
    <div className="relative w-full h-3/5">
      <img className="w-full h-[42rem]" src={backgroundImg} />
      <div className="absolute bottom-0 h-full flex w-full md:w-1/2 items-center justify-center bg-black bg-opacity-70 min-w-60">
